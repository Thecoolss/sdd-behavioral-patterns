...
class RemoveTicketCommand(Command):
    ...
    def execute(self) -> None:
        ...
        if self.removed_qty > 0:
            self.unit_price = self.cart.items().get(self.category, (0, 0.0))[1]
...
class SetPricingStrategyCommand(Command):
    ...
    def execute(self) -> None:
        ...
        self.previous_strategy = self.cart._pricing_strategy
        self.cart._pricing_strategy = self.strategy

    def undo(self) -> None:
        # TODO: restore the previous pricing strategy.
        self.cart._pricing_strategy = self.previous_strategy
...
class CartInvoker:
    ...
    def undo(self, n: int = 1) -> int:
        ...
        count = 0
        while count < n and self.history:
    ...
    def redo(self, n: int = 1) -> int:
        ...
        count = 0
        while count < n and self.redo_stack:
